...
from ml_fit_lib.gp import (
    DeepMultitaskVariationalGPModel, get_gp_scores, log_predictive_dist,
...
def main():
    ...
    model = DeepMultitaskVariationalGPModel(n_col = X_train.shape[-1], num_latents = NUM_LATENTS, num_tasks = Y_train.shape[-1])
    ...
    torch.save(model.state_dict(), DKL_MODEL_FILE)
    ...
    out_preds = path_join("out", "dkl_preds.png")
