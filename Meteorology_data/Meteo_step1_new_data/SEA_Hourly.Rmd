...
```{r, warning=FALSE, echo=FALSE, error=FALSE, message=FALSE}
# for having a complete data of seaview 
first.day <- 1 #first(hourly.data$day)
...
hourly.data.new <- 
  full_join(complete.year.day.hour, hourly.data, by = c('year','day', 'hour')) %>% 
