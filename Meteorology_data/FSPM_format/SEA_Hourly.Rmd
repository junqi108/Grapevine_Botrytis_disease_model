...
hourly.data.new <- 
  ...
  select(siteid, year,day,hour, relativehumi_avg, windspeed_avg, airtemperatu_avg,mean.solar.rad.w.m2)
 

names(hourly.data.new) =c("stn.no.", "year", "day", "hour", "mean.rh", "mean.wind.speed.m.s","mean.ta",                         "mean.solar.rad.w.m2")
